...
Mirrors starter-kits/python-defense/app/models.py in the simulator repo: requests
ignore unknown fields (so our service keeps working if organizers add context),
responses are strict (the evaluator rejects anything that does not match this
shape exactly). Kept dependency-free of the simulator package on purpose -- our
defense must run standalone.
"""
